...
from WWGfakephoton_Module import *
...
if args.isdata:
       Modules = [countHistogramsModule(),WWGfakephoton_Module()]
else:
       if args.year=='2016':
          Modules = [countHistogramsModule(),WWGfakephoton_Module(),jmeCorrections_ak4_MC(),puWeight_UL2016()]
       if args.year=='2016pre':
          Modules = [countHistogramsModule(),WWGfakephoton_Module(),jmeCorrections_ak4_MC(),puWeight_UL2016()]
       if args.year=='2017':
          Modules = [countHistogramsModule(),WWGfakephoton_Module(),jmeCorrections_ak4_MC(),puWeight_UL2017()]
       if args.year=='2018':
          Modules = [countHistogramsModule(),WWGfakephoton_Module(),puWeight_UL2018()]
